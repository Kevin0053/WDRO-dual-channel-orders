...
&= \min_{\lambda\geq0} \lambda \varepsilon + \frac{1}{N} \sum_{i = 1}^{N} \max_{\boldsymbol{\xi}\in\Xi} \left( \ell(\boldsymbol{\xi}, \boldsymbol{x}, \boldsymbol{\tau}) - \lambda \|\boldsymbol{\xi} - \widehat{\boldsymbol{\xi}}_i\| \right),  \qquad(4-2)
\end{align*}
$$
